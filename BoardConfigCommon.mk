...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3827302400
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 654311424
BOARD_SUPER_PARTITION_SIZE := 4586471424
BOARD_SUPER_PARTITION_METADATA_DEVICE := system

BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 4582277120  # Reserve 4MiB for overhead BOARD_SUPER_PARTITION_SIZE - (4 * 1024 * 1024)
