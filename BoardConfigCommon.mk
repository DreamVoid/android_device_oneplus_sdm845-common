...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3774873600
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 654311424
BOARD_SUPER_PARTITION_SIZE := 4534042624
BOARD_SUPER_PARTITION_METADATA_DEVICE := system

BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 4529848320 # Reserve 4MiB for overhead BOARD_SUPER_PARTITION_SIZE - (4 * 1024 * 1024)
...
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4 # Changed from squashfs for simplicity first, can revert if needed
# BOARD_VENDORIMAGE_SQUASHFS_COMPRESSOR := zstd
