...
# Partitions
BOARD_USES_LOGICAL_PARTITIONS := true

BOARD_SUPER_PARTITION_BLOCK_DEVICES := odm system vendor
BOARD_SUPER_PARTITION_ODM_DEVICE_SIZE := 104857600
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 2998927360  # PE Value, to fit actual device super partition limits
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 1073741824

# This group size must be == sum of device sizes above for the actual content.
# Sum: 104857600 (odm) + 2998927360 (system) + 1073741824 (vendor) = 4177526784
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 4177526784
...
# (4177526784 * 2) + 4096 = 8355053568 + 4096 = 8355057664
BOARD_SUPER_PARTITION_SIZE := 8355057664

BOARD_SUPER_PARTITION_METADATA_DEVICE := system

BOARD_BOOTIMAGE_PARTITION_SIZE := 67108864
BOARD_DTBOIMG_PARTITION_SIZE := 8388608
BOARD_ODMIMAGE_PARTITION_SIZE := 104857600 # Ensure this matches BOARD_SUPER_PARTITION_ODM_DEVICE_SIZE
BOARD_ODMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2998927360 # Ensure this matches BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE
...
BOARD_VENDORIMAGE_PARTITION_SIZE := 1073741824 # Ensure this matches BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE
