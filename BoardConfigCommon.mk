...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3920732160
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 847249408

# This group size must be == sum of device sizes above for the actual content.
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 4872839168 # sum of odm+system+vendor
BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_PARTITION_LIST := odm system vendor

# This is the total size of the super partition image on disk
# It should be BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE + metadata overhead (e.g., 4MiB)
BOARD_SUPER_PARTITION_SIZE := 4877033472 # (4872839168 + 4194304)
