...
BOARD_SUPER_PARTITION_ODM_DEVICE_SIZE := 104857600  # 100MB (保持，因为你的ODM内容应该不大)

# 我们需要 system + vendor + odm <= 4173332480
# 假设 odm 用掉 104857600，剩下 4068474880 给 system 和 vendor
# 假设你的 system 精简后能到 3.0 GB (3221225472 bytes)
# 那么 vendor 可以有 4068474880 - 3221225472 = 847249408 (约 808MB) - 这应该够你的 vendor (610MB)
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3221225472 # 约 3.0 GB
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 847249408  # 约 808 MB

BOARD_SUPER_PARTITION_SIZE := 4177526784 # (3.88 GB + 4MB metadata overhead) - 基于PE成功日志
BOARD_SUPER_PARTITION_METADATA_DEVICE := system

BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 4173332480 # 3.88 GB - 基于PE成功日志
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_PARTITION_LIST := odm system vendor

BOARD_BOOTIMAGE_PARTITION_SIZE := 67108864
BOARD_DTBOIMG_PARTITION_SIZE := 8388608
BOARD_ODMIMAGE_PARTITION_SIZE := $(BOARD_SUPER_PARTITION_ODM_DEVICE_SIZE)
BOARD_ODMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_PARTITION_SIZE := $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE)
...
BOARD_VENDORIMAGE_PARTITION_SIZE := $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE)
